...
func (s *BookService) GetAll(page, pageSize int, author, genre, startDate, endDate string) ([]model.Book, int64) {
	return s.bookRepo.GetAll(page, pageSize, author, genre, startDate, endDate)
}
